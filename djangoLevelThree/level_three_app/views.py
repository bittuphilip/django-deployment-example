...
from level_three_app.forms import NewUserForm
...
def index(request):
    return render(request, 'level_three_app/index.html')
...
def users(request):
    ...
    return render(request,"level_three_app/users.html",{'form':form})
